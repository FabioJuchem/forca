...
public class HangManGame {
    ...
    public static void main(String[] args) {
        ...
        List<String> alreadyTried = new ArrayList<>();
        ...
        while (wrongAnswers <= trys) {
            ...
            if (word.containCharacter(character)) {
                ...
                wrongAnswers++;
                if(wrongAnswers.equals(5)) {
                    System.out.println("Você perdeu!!! Boa sorte da próxima vez");
                    return;
                }
                var teste = trys - wrongAnswers;
                alreadyTried.add(character);
                System.out.println("Você errou e agora tem apenas: " + teste);
                System.out.println("Letras digitadas");
                printAll(alreadyTried);
            }
        }
    }
